...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Case studies displayed on the Kriyasoft website.';
  ...
  attributes: {
    ...
    pageBuilder: Schema.Attribute.DynamicZone<
      [
        ...
        'acf-sections.qubi-services-process',
        'acf-sections.qubi-services-cta',
        'acf-sections.qubi-client-ticker',
        'acf-sections.qubi-home-services',
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Services displayed on the Kriyasoft website.';
    displayName: 'Service';
    pluralName: 'services';
